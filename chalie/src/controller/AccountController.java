...
public class AccountController {
   ...
   public String resetMailSender(@RequestParam String email) throws NoSuchAlgorithmException, UnsupportedEncodingException, GeneralSecurityException {
   ...
   public String recoveryHandle(HttpSession session, @PathVariable String serial, @RequestParam(required=false, name="pass") String pass) {
      if(pass==null) {
